...
SWEP.PrintName = "Omega Fast Zombie"
...
SWEP.MeleeSize = 5.5 --1.5
SWEP.MeleeDamageType = DMG_SLASH
SWEP.Primary.Delay = 0.18

SWEP.SlowMeleeDelay = 0.4
...
SWEP.PounceReach = 28
SWEP.PounceSize = 12
SWEP.PounceStartDelay = 0.2
SWEP.PounceDelay = 0.5
SWEP.PounceVelocity = 1050
...
function SWEP:MeleeHitPlayer(ent, trace, damage)
	...
	local poison = ent:GiveStatus("poison")
	if poison and poison:IsValid() then
		poison:AddDamage(damage * 0.2)
		poison.Damager = self:GetOwner()
	end
end
