...
LANGUAGE.skillmod_n71 = "%s pulse slowdown"
...
LANGUAGE.zclasses_normal_d        = "Normal - Normal zombie classes that can be chosen at any time if they are unlocked and during wave"
LANGUAGE.zclasses_minibosses      = "Minibosses"
LANGUAGE.zclasses_minibosses_d    = "Minibosses - These zombies are slightly more powerful, with some having special abilities.\nHealth increased by 5 per player"
LANGUAGE.zclasses_demibosses      = "Demibosses"
LANGUAGE.zclasses_demibosses_d    = "Demibosses - Demiboss zombies are as half powerful as boss zombies, but some of them still have good abilities.\nHealth increased by 10 per player."
LANGUAGE.zclasses_bosses          = "Bosses"
LANGUAGE.zclasses_bosses_d        = "Bosses - Boss zombies that only appear before each wave start, with special abilities.\nHealth increased by 15 per player"
LANGUAGE.zclasses_superbosses     = "Superbosses"
LANGUAGE.zclasses_superbosses_d   = "Superbosses - Very powerful zombies that appear just before final wave.\nHealth increased by 35 per player"
...
LANGUAGE.class_omega_fast_zombie                  = "Omega Fast Zombie"
LANGUAGE.description_omega_fast_zombie            = ""
LANGUAGE.controls_omega_fast_zombie			          = "> PRIMARY: Claws\n> SECONDARY: Lunge / Climb wall\n> RELOAD: Scream\n> ON FATAL HIT IN LEGS: Transform"
...
LANGUAGE.class_demiboss_nightmare   							= "Nightmare (Demiboss)"
LANGUAGE.description_demiboss_nightmare						= "Downgraded version of Nightmare.\nDoes not inflict dim vision status effect."
LANGUAGE.controls_demiboss_nightmare							= "> PRIMARY: Death touch\n> SECONDARY: Moan"
...
LANGUAGE.demiboss_class_select	= "You will be %s the next time you're a demiboss zombie."
