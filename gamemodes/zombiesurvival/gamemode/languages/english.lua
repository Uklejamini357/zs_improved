...
LANGUAGE.skillmod_n25 = "%s maximum blood armor multiplier"
LANGUAGE.skillmod_n26 = "%s blood armor generated"
LANGUAGE.skillmod_n27 = "%s jump power"
LANGUAGE.skillmod_n28 = "%s weapon bullet damage"
...
LANGUAGE.skillmod_n33 = "%s effectiveness of slows"
...
LANGUAGE.skillmod_n59 = "%s point gain multiplier"
LANGUAGE.skillmod_n60 = "%s XP gain multiplier"
...
LANGUAGE.skillmod_n89 = "%s arsenal item prices"
...
LANGUAGE.skillmod_n105 = "%s all damage taken"
LANGUAGE.skillmod_n106 = "%s damage dealt"
LANGUAGE.skillmod_n107 = "%s remantler prices"
LANGUAGE.skillmod_n108 = "%s health to nailed props"

-- Class selection

LANGUAGE.zclasses_normal        = "Normal"
LANGUAGE.zclasses_minibosses    = "Minibosses"
LANGUAGE.zclasses_semibosses    = "Semibosses"
LANGUAGE.zclasses_bosses        = "Bosses"
LANGUAGE.zclasses_superbosses   = "Superbosses"
...
LANGUAGE.zclass_points   = "Points: %s (Damage per point: %s)"
...
<li>Endless mode! See how long you can survive with survivors until you are downed.</li>
</ul>
</p>
...
LANGUAGE.controls_eradicator_ii						        = "> PRIMARY: Claws\n> SECONDARY: Scream\n> ON FATAL HIT: Revive"
...
LANGUAGE.controls_howler    							        = "> PRIMARY: Claws\n> SECONDARY: Howl\n> RELOAD: Moan"
LANGUAGE.class_lacerator_charging_deadly			  	= "Deadly Charger"
LANGUAGE.description_lacerator_charging_deadly		= "Certain mutations made Charger way deadlier than it was.\nHas increased max charge time and -20% damage taken while charging."
LANGUAGE.controls_lacerator_charging_deadly				= "> PRIMARY: Bleeding Claws\n> ON HIT HUMAN: Bleed\n> SECONDARY: Deadly Charge\n> RELOAD: Scream"
LANGUAGE.class_sigil_annihilator                  = "Sigil Annihilator"
LANGUAGE.description_sigil_annihilator            = "Born from corrupted sigils, this zombie gained powerful ability to corrupt sigils way faster.\nThis zombie grows stronger for every sigil corrupted.\n-15% damage taken for every sigil corrupted (max 25%) and 2.5x damage done to sigils"
LANGUAGE.controls_sigil_annihilator               = "> PRIMARY: Claws\n> RELOAD: Scream"
LANGUAGE.class_reborn_nightmare                   = "Reborn Nightmare"
LANGUAGE.description_reborn_nightmare             = "Nightmare reborn from ancient corrupted sigil, becoming extremely strong and hunts down survivors at their own will!\nOverpowered version of Nightmare, inflicts deadly statuses on hit."
LANGUAGE.controls_reborn_nightmare                = "> PRIMARY: Deadly Claws\n> SECONDARY: Deathly Blinding Touch\n> RELOAD: Deadly Moan"
LANGUAGE.class_corrupted_zombie                   = "Corrupted Zombie"
LANGUAGE.description_corrupted_zombie             = "Born from corrupted sigil, this zombie becomes more powerful for every sigil corrupted.\n-12.5% damage taken for every corrupted sigil (max 35%)"
LANGUAGE.controls_corrupted_zombie                = "> PRIMARY: Claws\n> SECONDARY: Scream\n> RELOAD: Moan\n> SPRINT: Feign death\n> ON FATAL HIT IN LEGS: Revive / Transform"
LANGUAGE.class_omega_zombie                       = "Omega Zombie"
LANGUAGE.description_omega_zombie                 = "Zombie that gained rainbow power also gained great power - ωX better than normal zombie\nHas boosted cade damage."
LANGUAGE.controls_omega_zombie                    = "> PRIMARY: Omeged Claws\n> SECONDARY: Scream\n> RELOAD: Moan\n> SPRINT: Feign death\n> ON FATAL HIT IN LEGS: Revive / Transform"
LANGUAGE.class_chem_zombie                        = "Chem Zombie"
LANGUAGE.description_chem_zombie                  = "A volatile zombie that explodes when it dies, dealing poison damage to nearby survivors.\nHas chem aura that inflicts 1 poison damage every 2 seconds."
LANGUAGE.controls_chem_zombie                     = "> ON DEATH: Chemical Explosion"
LANGUAGE.class_semiboss_nightmare   							= "Nightmare (Semiboss)"
LANGUAGE.description_semiboss_nightmare						= "Downgraded version of Nightmare.\nDoes not inflict dim vision status effect."
LANGUAGE.controls_semiboss_nightmare							= "> PRIMARY: Death touch\n> SECONDARY: Moan"
...
LANGUAGE.ach_difficulty_5         = "Difficult"
LANGUAGE.ach_difficulty_6         = "Hard"
...
-- Loaded only next frame (not used because of errors)
/*
local LANG = LANGUAGE
timer.Simple(0.05, function(LANG)
-- Skill modifiers

  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s maximum health"
  LANG["skillmod_n"..SKILLMOD_BLOODARMOR] = "%s maximum blood armor"
  LANG["skillmod_n"..SKILLMOD_SPEED] = "%s movement speed"
  LANG["skillmod_n"..SKILLMOD_WORTH] = "%s starting worth"
  LANG["skillmod_n"..SKILLMOD_MELEE_DAMAGE_MUL] = "%s melee damage"
  LANG["skillmod_n"..SKILLMOD_MELEE_RANGE_MUL] = "%s melee range multiplier"
  LANG["skillmod_n"..SKILLMOD_MELEE_RANGE_ADD] = "%s melee range"
  LANG["skillmod_n"..SKILLMOD_MELEE_KNOCKBACK_MUL] = "%s melee knockback"
  LANG["skillmod_n"..SKILLMOD_MELEE_SWING_DELAY_MUL] = "%s melee swing impact delay"
  LANG["skillmod_n"..SKILLMOD_MELEE_ATTACK_DELAY_MUL] = "%s melee attack delay"
  LANG["skillmod_n"..SKILLMOD_MELEE_DAMAGE_TO_BLOODARMOR_MUL] = "%s melee damage converted to blood armor"
  LANG["skillmod_n"..SKILLMOD_MELEE_MOVEMENTSPEED_ON_KILL] = "%s speed on melee kill for 10 seconds"
  LANG["skillmod_n"..SKILLMOD_MELEE_POWERATTACK_MUL] = "%s melee power attack"
  LANG["skillmod_n"..SKILLMOD_MELEE_LEG_DAMAGE_ADD] = "%s melee leg damage dealt"
  LANG["skillmod_n"..SKILLMOD_MELEE_DAMAGE_TAKEN_MUL] = "%s melee damage taken"
  LANG["skillmod_n"..SKILLMOD_POISON_DAMAGE_TAKEN_MUL] = "%s poison damage taken"
  LANG["skillmod_n"..SKILLMOD_BLEED_DAMAGE_TAKEN_MUL] = "%s bleed damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s explosive damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fire damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s physics impact damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s projectile damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s melee damage taken reflected to melee attackers"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s additional damage reflected to melee attackers"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s blood armor damage absorption"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s maximum blood armor"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s blood armor generated"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s jump power"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s bullet damage"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s weapon fire delay"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s weapon reload speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s weapon draw speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s weapon aim spread"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s effectivness of slows"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s movement speed reduction with heavy weapons"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s low health slow intensity"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fall damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fall damage threshold"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fall damage knockdown duration"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fall damage slowdown"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s recovery from food"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s time to eat food"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s unarmed strike damage"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s time before next unarmed strike"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s swing delay with the Carpenter Hammer"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Controllable Health"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Controllable Speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Controllable Handling"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Manhack Damage"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Manhack Health"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s barricade phasing movement speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s medical kit cooldown"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s medic tool effectivness"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s repair rate"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Turret health"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Turret scan speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s turret angle scan"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s damage vs. yourself"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s starting points"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s point multiplier"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s XP multiplier"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s deployable health"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s deployable pack time"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s drone speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s drone carry mass"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s drone gun range"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s medic tool fire delay"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s resupply delay"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s zapper and repair field range"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s zapper and repair field delay"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s healing received"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s slow from pulse weapons and stun batons"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s knockdown time"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s prop carrying max weight limit"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s prop carrying max volume limit"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s prop carrying slow down"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s object throwing strength"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s effect of vision affecting effects"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s effect of dim vision and ability to see in dark"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s bleeding speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s poison damage over time speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s sigil teleportation time"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s explosive damage radius"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s medic tool reload speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s fright duration"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s accuracy bonus from ironsighting"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s projectile speed"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s starting scrap"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s end of wave points"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s arsenal item prices"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s cloud bomb radius"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s cloud bomb time"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s projectile damage"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s explosive damage"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Turret range"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s effect of aim shake effects"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s healing effectiveness on medical darts"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Pistol)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (SMG)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Assault)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Shotgun)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Rifle)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Bolts)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Pulse)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s Reload Speed (Explosive)"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s all damage taken"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s damage dealt"
  LANG["skillmod_n"..SKILLMOD_HEALTH] = "%s remantler prices"
end)
*/
