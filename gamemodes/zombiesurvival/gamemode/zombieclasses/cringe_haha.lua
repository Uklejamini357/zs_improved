CLASS.Name = "CRINGE?"
CLASS.TranslationName = "class_"
CLASS.Description = "description_"
CLASS.Help = "controls_"
...
CLASS.Health = (248)+434-5508
CLASS.DynamicHealth = (845)+354-9912
CLASS.Speed = 69
...
if SERVER then
	function CLASS:OnSpawned(pl)
		timer.Simple(2, function()
			...
			pl:CenterNotify(COLOR_RED, "absolutely no")
			pl:KillSilent()
			pl:CreateRagdoll()
			pl.StartSpectating = CurTime() + 3
			pl.StartCrowing = CurTime() + 3
		end)
	end
end
