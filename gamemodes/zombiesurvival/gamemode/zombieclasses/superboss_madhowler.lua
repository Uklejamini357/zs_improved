CLASS.Name = "Mutated Howler"
CLASS.TranslationName = "class_mutatedhowler"
CLASS.Description = "description_mutatedhowler"
...
function CLASS:PlayDeathSound(pl)
	pl:EmitSound("npc/antlion_guard/antlion_guard_die"..math_random(2)..".wav", 100, math_random(60, 75))

	return true
end

function CLASS:PlayPainSound(pl)
	pl:EmitSound("npc/combine_gunship/gunship_pain.wav", 75, math_random(75, 85))
...
CLASS.IconColor = Color(191,191,191)
