CLASS.Name = "Reborn Nightmare"
CLASS.TranslationName = "class_reborn_nightmare"
CLASS.Description = "description_reborn_nightmare"
CLASS.Help = "controls_reborn_nightmare"
...
CLASS.SWEP = "weapon_zs_rebornnightmare"
...
function CLASS:PlayerFootstep(pl, vFootPos, iFoot, strSoundName, fVolume, pFilter)
	pl:EmitSound(StepSounds[math_random(#StepSounds)], 70, 85)
...
function CLASS:PrePlayerDraw(pl)
	render.SetColorModulation(0.9, 0.9, 0.4)
end
