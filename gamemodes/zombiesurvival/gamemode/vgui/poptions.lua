...
function MakepOptions()
	...
	check:SetTextColor(COLOR_YELLOW)
	...
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText("Always display health target")
	...
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText("Display rainbow text")
	...
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(1, 250)
	slider:SetConVar("zs_maxammodeposit")
	slider:SetText("Max ammo to deposit to deployables per use")
	slider:SizeToContents()
	list:AddItem(slider)
