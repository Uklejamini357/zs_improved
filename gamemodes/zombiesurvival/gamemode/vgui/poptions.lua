...
function MakepOptions()
	...
	check:SetTooltip("(H) Unlocks/Activates/Deactivates skill with just 1 click")
	...
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText("(H) Display rainbow text")
	...
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText("(H) Disable resupply ding sound")
